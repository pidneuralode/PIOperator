...
import torch
import sys
from model.deepONet.POD_deepONet1d import PODDeepONet
...
parser.add_argument('--result-file',
                    default='E:\\dfno\\PIOperator\\results\\burgers1d\\loss_poddeeponet.txt',
                    help='the path file to store the result of this experiment'
                    )
parser.add_argument('--model-path',
                    default='E:\\dfno\\PIOperator\\results\\burgers1d\\model_poddeeponet.pth',
                    type=str,
...
def main():
    ...
    # model
    modes = 32
    burgers_model = PODDeepONet([128, 128, 128, modes], "tanh").to(device=device)
