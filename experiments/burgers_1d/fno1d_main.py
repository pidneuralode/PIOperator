...
import torch
import sys
from model.fno.fno1d import FNO1d
...
parser.add_argument('--result-file',
                    default='E:\\dfno\\PIOperator\\results\\burgers1d\\loss_fno.txt',
                    help='the path file to store the result of this experiment'
                    )
parser.add_argument('--model-path',
                    default='E:\\dfno\\PIOperator\\results\\burgers1d\\model_fno.pth',
                    type=str,
...
def main():
    ...
    # model
    burgers_model = FNO1d(modes=16, width=64).to(device=device)
